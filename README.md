...
- **Languages**: Java , C , Embedded C , JavaScript, TypeScript, Python, Solidity ![My Skills](https://skillicons.dev/icons?i=java,python,go,bash,git,github,gitlab,figma,javascript,solidity,c,typescript,postman,autocad,aws,googlecloud,azure,jenkins,docker,jwt)
